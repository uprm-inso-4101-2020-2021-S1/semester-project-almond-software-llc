...
public class Department {
	 ...
	 * @param Name Name of the department (IE "Department of Computer Engineering")
	 * @param ShortName Short name of the department (IE "ICOM")
	 */
	public Department(String Name, String ShortName) {
		this.Name=Name; //Set name
		this.ShortName=ShortName;
		CourseCatalog = new Hashtable<String, Course>(); //Initialize the Course Directory.
	}
	
	/**
	 * Creates a department with the specified name, Short Name, and Course Directory 
	 * @param Name Name of the department (IE "Department of Computer Engineering")
	 * @param ShortName Short name of the department (IE "ICOM")
	 * @param CourseCatlog Catalog of courses, where the key is the course number (IE 3011) and the value is the course.
	 */
	public Department(String Name, String ShortName, Map<String, Course> CourseCatlog) {
		this(Name,ShortName);
	 ...
	 * @param obj
	 * @return True if and only if the object is not null, is an instance of Department, and has the same Short Name.
	 */
